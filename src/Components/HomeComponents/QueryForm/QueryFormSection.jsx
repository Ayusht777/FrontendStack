...
const QueryFormSection = () => {
  return (
    <section className=" relative  my-16 w-full max-w-[1200px] ">
      <div className="   w-full rounded-lg bg-[radial-gradient(#D7F400_1px,#111213_1px)]  p-0 text-white   outline outline-2 outline-Border md:bg-[size:1.5rem_1.5rem] md:py-16">
